...
class QuestionStatus(db.Model):
    ...
    status = db.Column(db.String(50), nullable=False, default="Not Visited")  # e.g., Answered, Not-Answered
    chosen_option = db.Column(db.Integer, nullable=True)  # what user selected (1-4), or NULL/-1 if not answered
    correct_option = db.Column(db.Integer, nullable=False)  # store from Question table during insert/update
